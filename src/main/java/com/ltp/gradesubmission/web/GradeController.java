...
public class GradeController {
    ...
    @GetMapping("/student/{studentId}/course/{courseId}")  // get grade of a student using his student id and course id
    public ResponseEntity<Grade> getGrade(@PathVariable Long studentId, @PathVariable Long courseId) {
        return new ResponseEntity<>(gradeService.getGrade(studentId, courseId), HttpStatus.OK);
    }

    @PostMapping("/student/{studentId}/course/{courseId}")  // save new given grade of a student for a course
    ...
    @PutMapping("/student/{studentId}/course/{courseId}")  // update a given grade of a student for a given course
    ...
    @DeleteMapping("/student/{studentId}/course/{courseId}")  // delete a given grade of a student for a given course
    public ResponseEntity<HttpStatus> deleteGrade(@PathVariable Long studentId, @PathVariable Long courseId) {
        gradeService.deleteGrade(studentId, courseId);
        return new ResponseEntity<>(HttpStatus.NO_CONTENT);
    }

    @GetMapping("/student/{studentId}")  // get all grades of a particular student using the id
    public ResponseEntity<List<Grade>> getStudentGrades(@PathVariable Long studentId) {
        return new ResponseEntity<>(gradeService.getStudentGrades(studentId), HttpStatus.OK);
    }

    @GetMapping("/course/{courseId}")  // get all grades of a particular course using the id
